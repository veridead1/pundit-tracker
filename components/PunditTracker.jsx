...
var SEED_DATA = [
  ...
  { id: "seed23", commentator: "Stanley Druckenmiller (Duquesne)", prediction: "Going all-in on AI for the second consecutive quarter: made major additions to Amazon, Meta Platforms, and Alphabet. Sees these as the picks-and-shovels plays of the AI buildout cycle.", asset: "AMZN", direction: "bullish", target: null, timeframe: "2026", source: "Motley Fool", date_stated: "2026-01-02", created: "2026-05-22T12:22:00Z" },
  { id: "seed24", commentator: "Stanley Druckenmiller (Duquesne)", prediction: "Sold entire Nvidia and Palantir positions. Found new AI favorites instead. 'AI might be a little overhyped now, but underhyped long term.' Still very bullish on AI infrastructure but rotating away from the obvious names.", asset: "NVDA", direction: "bearish", target: null, timeframe: "2026", source: "Motley Fool / 247WallSt", date_stated: "2026-01-16", created: "2026-05-22T12:23:00Z" },
  { id: "seed25", commentator: "Stanley Druckenmiller (Duquesne)", prediction: "Q1 2026 portfolio reveals no Nvidia. Instead bought Broadcom (195,955 shares), Micron Technology (23,400 shares), and Intel (411,400 shares) as the next stage AI semiconductor plays.", asset: "AVGO", direction: "bullish", target: null, timeframe: "2026", source: "IndexBox / Motley Fool", date_stated: "2026-03-31", created: "2026-05-22T12:24:00Z" },
  { id: "seed26", commentator: "Stanley Druckenmiller (Duquesne)", prediction: "Sold Meta Platforms and added heavily to Alphabet while initiating a new position in Amazon. Rotating within AI winners toward those with the most defensible long-term moats.", asset: "GOOGL", direction: "bullish", target: null, timeframe: "2026", source: "Motley Fool", date_stated: "2026-04-24", created: "2026-05-22T12:25:00Z" },
  { id: "seed27", commentator: "Stanley Druckenmiller (Duquesne)", prediction: "Loaded up on Sea (SE) after the stock fell 77% from its $300 highs. Analysts project 22% EPS growth in 2026 — Druckenmiller sees strong fundamentals as a solid entry point before the rerating.", asset: "SE", direction: "bullish", target: null, timeframe: "2026", source: "247WallSt", date_stated: "2026-04-01", created: "2026-05-22T12:26:00Z" },
  { id: "seed28", commentator: "Peter Schiff (Euro Pacific Capital)", prediction: "Gold will reach $6,000 in 2026. The USD Index will fall to 70. Gold mining stocks will double from here. Newmont is poised to become the top-performing stock in the S&P 500, surpassing even Palantir.", asset: "GLD", direction: "bullish", target: "$6,000 gold", timeframe: "2026", source: "TradingKey / CoinPedia / Canadian Mining Report", date_stated: "2026-01-01", created: "2026-05-22T12:27:00Z" },
  ...
  { id: "seed32", commentator: "BlackRock Investment Institute", prediction: "AI-driven earnings upgrades rank in the top 5 since 1988. Upgrades developed market equities to overweight. Favors technology, AI-linked healthcare, and energy sectors tied to the AI buildout and rising power demand.", asset: "QQQ", direction: "bullish", target: null, timeframe: "2026", source: "BlackRock Weekly Commentary", date_stated: "2026-01-01", created: "2026-05-22T12:31:00Z" },
  ...
  { id: "seed36", commentator: "Fidelity International", prediction: "AI is 'the defining theme for equity markets' in 2026. Technology will keep 'trumping tariffs and traditional macro drivers.' Maintaining a global equity overweight with technology as the primary conviction.", asset: "QQQ", direction: "bullish", target: null, timeframe: "2026", source: "Bloomberg / Fidelity International", date_stated: "2026-01-01", created: "2026-05-22T12:35:00Z" },
  ...
  { id: "seed41", commentator: "Jeff Gundlach (DoubleLine)", prediction: "The bond market is 'starting to price in inflation lasting longer.' The 'weapon is the deficit-based economy' — structural US debt levels are an unresolved risk that markets are underpricing. Favors gold as a hedge.", asset: "TLT", direction: "bearish", target: null, timeframe: "2026", source: "CNBC", date_stated: "2026-04-29", created: "2026-05-22T12:40:00Z" },
  ...
  { id: "seed52", commentator: "Cathie Wood (ARK Invest)", prediction: "Tesla will reach $7,000 per share within 5 years (pre-split; equivalent to $1,400 post-split). ARK's bull case is built on robotaxi autonomous driving revenue reaching scale. 'We are willing to take on that controversy and we believe we will be proven right.'", asset: "TSLA", direction: "bullish", target: "$7,000 pre-split / $1,400 post-split", timeframe: "2024-2025 (5-year)", source: "ARK Invest research / Bloomberg interview", date_stated: "2020-01-21", created: "2026-05-22T12:51:00Z" },
  { id: "seed53", commentator: "Cathie Wood (ARK Invest)", prediction: "The COVID crash is the best buying opportunity ARK has ever seen. Doubling down on Tesla, genomics, and fintech names. 'Every single one of our strategies is performing better than we expected going into this crisis.' Innovation will accelerate as companies are forced to adapt.", asset: "ARKK", direction: "bullish", target: null, timeframe: "2020-2025", source: "ARK Invest blog / Bloomberg", date_stated: "2020-03-19", created: "2026-05-22T12:52:00Z" },
  ...
  { id: "seed55", commentator: "Michael Burry", prediction: "Unprecedented COVID fiscal and monetary stimulus will cause severe inflation in consumer goods — not just asset prices. 'Prepare for inflation.' The trillions being printed will eventually flow into the real economy and crush purchasing power of the dollar.", asset: "USD", direction: "bearish", target: null, timeframe: "2021-2022", source: "Twitter (@michaeljburry) / Scion Asset Management", date_stated: "2020-04-28", created: "2026-05-22T12:54:00Z" },
  { id: "seed56", commentator: "Warren Buffett", prediction: "Sold all holdings in the four major US airlines — American, Delta, Southwest, and United — at a significant loss. 'The world has changed for the airlines. I don't know how it's changed, but I don't want to own them. I made a mistake.' First major Buffett admission of error since 2008.", asset: "Airlines", direction: "bearish", target: null, timeframe: "2020", source: "Berkshire Hathaway Annual Meeting / CNBC", date_stated: "2020-05-02", created: "2026-05-22T12:55:00Z" },
  { id: "seed57", commentator: "Peter Schiff (Euro Pacific Capital)", prediction: "The Fed's emergency rate cuts to zero and unlimited QE will destroy the dollar. Gold will surge to all-time highs and beyond. 'This crisis will be far worse than 2008 because the Fed has already used all its bullets. The dollar's reign as world reserve currency is ending.'", asset: "GLD", direction: "bullish", target: "All-time highs and beyond", timeframe: "2020-2021", source: "Euro Pacific Capital / Twitter / YouTube channel", date_stated: "2020-03-20", created: "2026-05-22T12:56:00Z" },
  ...
  { id: "seed66", commentator: "Jim Cramer", prediction: "Created the 'Cramer Covid-19 Index' of 100 pandemic winners. Called Peloton 'the ultimate stay-at-home stock' and championed Zoom, Netflix, Amazon, and DocuSign. 'These companies have gone from zero to household names in the blink of an eye. Even when we beat Covid, Zoom's here to stay.'", asset: "ZM", direction: "bullish", target: null, timeframe: "2020-2021", source: "CNBC Mad Money", date_stated: "2020-03-31", created: "2026-05-22T13:05:00Z" },
  ...
  { id: "seed70", commentator: "Paul Tudor Jones", prediction: "Disclosed a 1–2% Bitcoin position in a letter to clients. 'Bitcoin reminds me of gold in the early 1970s.' Became the first major mainstream hedge fund manager to publicly endorse Bitcoin as a macro inflation hedge against central bank money printing. Called it 'the fastest horse in the race.'", asset: "BTC", direction: "bullish", target: null, timeframe: "2020-2021", source: "Tudor Investment Corp investor letter / CNBC", date_stated: "2020-05-07", created: "2026-05-22T13:09:00Z" },
  ...
  { id: "seed72", commentator: "Jim Cramer", prediction: "'Stay-at-home stocks will keep roaring until there is a coronavirus vaccine.' Doubled down on Zoom, Peloton, Roku, and Netflix as structural beneficiaries, not just temporary winners. Called any selloff in these names 'one more reason to buy them.'", asset: "PTON", direction: "bullish", target: null, timeframe: "2020", source: "CNBC Mad Money", date_stated: "2020-10-15", created: "2026-05-22T13:11:00Z" },
      ...
      <div style={{ marginBottom: 28 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div onClick={handleTitleClick} style={{ cursor: "default", userSelect: "none" }}>
            <h1 style={{ margin: 0, fontSize: 44, fontWeight: 400, color: "#fafaf9", letterSpacing: 2, fontFamily: "'Bebas Neue', sans-serif" }}>HINDSIGHT CAPITAL</h1>
